// Authentication Page - Handles x402 Payment
...
export default function AuthenticatePage() {
  ...
  useEffect(() => {
    // Start payment process automatically when page loads
    setPaymentStatus("connecting");
  }, []);

  const handlePaymentSuccess = () => {
    setPaymentStatus("success");
    // Redirect to video content after short delay
    setTimeout(() => {
      router.push("/video-content");
    }, 1500);
  };
      ...
      <div className="container relative z-10 mx-auto max-w-2xl px-4 py-16">
        <header className="mb-12 text-center">
          ...
          <p className="text-lg text-gray-300">
            ...
            {paymentStatus === "success" && "Redirecting to content..."}
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm text-emerald-200/80">
                        Your payment has been confirmed on the Avalanche
                        network. Redirecting you now...
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="rounded-2xl border border-white/5 bg-white/5 p-6">
                ...
                <ul className="space-y-2 text-sm text-gray-400">
                  <li className="flex gap-2">
                    ...
                    <span>Make sure you have USDC on Avalanche Mainnet</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-red-400">•</span>
                    <span>Check that your wallet is connected</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-red-400">•</span>
                  ...
                  <li className="flex gap-2">
                    <span className="text-red-400">•</span>
                    <span>Try refreshing and connecting again</span>
                  </li>
                </ul>
              </div>
        ...
        {/* Hidden payment client component */}
